...
export function SaleDialogForm({ isOpen, onClose, onSubmit }: SaleDialogFormProps) {
    const { user } = useUser();
            ...
            {formData.products.map((product, index) => (
              <div key={index}>
                ...
                <Controller
                  ...
                  control={control}
                  render={({ field }) => (
                    <Input placeholder="Status" {...field} value={productTypes[product.status as keyof typeof productTypes]} readOnly />
                  )}
                />
                <Controller
