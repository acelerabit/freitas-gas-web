...
interface MarkAllAsPaidProps {
  open: boolean;
  onOpenChange: () => void;
  customerId: string;
}

export function MarkAllAsPaid({ open, onOpenChange, customerId }: MarkAllAsPaidProps) {
  ...
  async function markAsPaidTransaction() {
    ...
    const response = await fetchApi(`sales/mark-all-as-paid/${customerId}`, {
      method: "PATCH",
      body: JSON.stringify({
    ...
    <AlertDialog open={open} onOpenChange={onOpenChange}>
      <AlertDialogContent>
        <AlertDialogHeader>
          ...
          <AlertDialogDescription>
            Todos os débitos desse cliente serão marcados como pago
          </AlertDialogDescription>
        </AlertDialogHeader>
